  ...
  const educationItems = [
    {
      ...
      date: "2024 - Present",
      description: " freecodecamp - focus on javascript MERN stack developer",
    },
    {
      title: "Diploma in Elementary Education (D.El.Ed)",
      date: "2024- Present",
      description:
        "Focused on child pedagogy, teaching methodologies, educational psychology, and classroom management.",
    },

    {
      ...
      date: "2024",
      description:
        "Studied Philosophy, History, Sanskrit, and Geography with a focus on critical thinking, cultural studies, and analytical skills.",
    },
  ];
