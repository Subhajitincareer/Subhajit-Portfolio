...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <motion.div
        className={`fixed md:sticky top-0 h-screen inset-y-0 left-0 z-40 w-64 bg-eerie-black border-r border-onyx flex flex-col transition-transform duration-300 ease-in-out ${
